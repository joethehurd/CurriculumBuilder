...
public partial class EditCoursePage : ContentPage
{
    ...
    {
        // populate fields with selected course's details
        CourseNameEntry.Text = ViewCoursePage.selectedCourse.Name;
        CourseStartDatePicker.Date = ViewCoursePage.selectedCourse.Start.ToLocalTime();
        CourseEndDatePicker.Date = ViewCoursePage.selectedCourse.End.ToLocalTime();
        CourseInstructorNameEntry.Text = ViewCoursePage.selectedCourse.InstructorName;
        CourseInstructorPhoneEntry.Text = ViewCoursePage.selectedCourse.InstructorPhone;
        CourseInstructorEmailEntry.Text = ViewCoursePage.selectedCourse.InstructorEmail;
        CourseStatusPicker.SelectedItem = ViewCoursePage.selectedCourse.Status;
        CourseAlertsPicker.SelectedItem = ViewCoursePage.selectedCourse.Alerts;
        CourseNotesEntry.Text = ViewCoursePage.selectedCourse.Notes;
    }
    ...
    private async void SaveCourseButton_Clicked(object sender, EventArgs e)
    {
        ...
        // update course
        DataAccessService.UpdateCourse(ViewCoursePage.selectedCourse.Id, CourseNameEntry.Text, CourseStartDatePicker.Date, CourseEndDatePicker.Date, CourseInstructorNameEntry.Text, CourseInstructorPhoneEntry.Text, CourseInstructorEmailEntry.Text, CourseStatusPicker.SelectedItem.ToString(), CourseNotesEntry.Text, CourseAlertsPicker.SelectedItem.ToString(), ViewTermPage.selectedTerm.Id);
